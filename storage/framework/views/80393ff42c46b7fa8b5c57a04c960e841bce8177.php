...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('site/css/newLogin.css')); ?>">
</head>
<body>

    <main class="card">
        <section class="esquerda">
            <img src="<?php echo e(asset('site/img/LogoMatch.svg')); ?>" alt="Imagem Logo" srcset="" class="imagem_logo">
            ...
            <section class="controle_login-social">
                <a href="#">
                    <img src="<?php echo e(asset('site/img/logo-google.png')); ?>" alt="Logo Google">
                    Login com Google
                </a>
                <a href="#">
                    <img src="<?php echo e(asset('site/img/logo-facebook.png')); ?>" alt="Logo Google">
                    Login com Facebook
                </a>
            </section>
        </section>
        ...
        <section class="direita">
            <div class="background_imagem">
                ...
                <img src="<?php echo e(asset('site/img/LoginTest.svg')); ?>" alt="Imagem Fundo">
            </div>
        </section>
...
<?php /**PATH D:\Desktop\Nova Pasta\FastSolutions\Desenvolvimento\resources\views/site/test.blade.php ENDPATH**/ ?>