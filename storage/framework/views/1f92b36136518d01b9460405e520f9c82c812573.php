...
<html lang="pt-br">
  ...
  <body>
      ...
      <div class="container">
        ...
        >
          ...
          <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
              <li class="nav-item">
                <a class="nav-link active" href="<?php echo e(route('index')); ?>">Página Inicial</a>
              </li>
              <li class="nav-item">
    ...
    <!--//HEADER-->
    <body>
<html><?php /**PATH D:\Downloads\FastSolutions\Desenvolvimento\resources\views/layouts/header.blade.php ENDPATH**/ ?>