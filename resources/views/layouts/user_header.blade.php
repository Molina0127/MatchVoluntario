            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        @guest
                            @if (Route::has('loginUsuario'))
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('loginUsuario') }}">{{ __('Login') }}</a>
                                </li>
                            @endif

                            @if (Route::has('createUsuario'))
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('createUsuario') }}">{{ __('Cadastro') }}</a>
                                </li>
                            @endif
